...
/**** AM_powOf2( int power ) ****
 ...
 Comment:
         Eixe xrhsimopoih8ei gia na mh xreiazotan na xrhsimopoiei h standard math library,
         h opoia omws xrhsimopoihtai logw tou HF epipedou, so, this one is obsolete.
*/
